...
cp /usr/share/nestopia/NstDatabase.xml ./AppDir/shared/bin
cp -r /usr/share/nestopia/palettes ./AppDir/shared/bin
cp -r /usr/share/nestopia/shaders ./AppDir/shared/bin
